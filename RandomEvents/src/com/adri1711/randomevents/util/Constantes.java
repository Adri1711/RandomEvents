...
public class Constantes {
	...
	public static final String ERROR = "§c§lSome error ocurred, check the server log.";

	public static final String INVALID_CMD = "§c§lInvalid command, do /randomevent or /revent to see the valid commands";
	...
	// public static final String ON_COOLDOWN = "§6§lYou have recently done this
	// Boss Battle, this match has %seconds% seconds of cooldown";
	...
	public static final String MATCH_FULL = "§c§lThe match is already full";
	...
	public static final String MATCHES = "§6§lMatches:";
	...
	// public static final String PERMISO_BYPASS_COOLDOWN =
	// "bossbattle.cooldown.bypass";

	// public static final String PERMISSION_STOP_ARENA =
	// "bossbattle.admin.stop.battle";
	...
	public static final String EVENT_ANNOUNCE = "§6§lThe event §e§l'%event%'§6§l of type  §e§l'%type%'§6§l, begins in: ";
	...
	public static final String WINNERS = "§e§l%players% §6§lwon the Random Event §e§l'%event%'§6§l ! Congratulations!";
	...
	public static final String NOW_GEMS = "§6§lThe player §e§l%player% §6§lhas now §e§l%points% §6§lgems";

	public static final String NOW_PROTECTED = "§6§lYou are now protected for 3 seconds";

	public static final String MATCH_BEGIN_SOON = "§6§lThe Random Event will begin soon";

	public static final String GREEN = "§2§l";

	public static final String LOST_GEMS = "§e§l%player% §6§llost all gems";
